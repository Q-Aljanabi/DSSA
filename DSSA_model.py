...
class DSSA(nn.Module):
    ...
    # def forward(self, data):
    #     graph_features = self.graph_processor(data)
    #     smiles_features = self.smiles_processor(data.smiles)
    #     fused_features = self.cross_attention(graph_features, smiles_features)
    #     out = self.combined_classifier(fused_features)
    #     return out.squeeze(-1)
